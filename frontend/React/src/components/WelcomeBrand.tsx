...
const WelcomeBrand = () => {
    ...
    const handleNavigation=(e: { preventDefault: () => void; })=>{
        ...
        let steps=localStorage.getItem('completedStep');
         if(role=='buyer' && steps=='0'){
            navigate('/OnboardingBuyer/ProfileBuyer');
        }else if(role=='buyer' && steps=='1'){
    ...
    return (
        <div className="rounded-sm md:py-[94px] py-[60px] px-[15px] text-center bg-white center">
            ...
            <div>
                ...
                <p className="text-[#535D7A] text-[14px] font-[400] leading-[20px]">Let's set up your profile and we will show you unlimited chrome extension<br /> marketplace for perfect you match your criteria,</p>
            </div>
            <div className="md:px-[110px] md:pt-[65px] pt-[50px] md:pb-[48px] pb-[50px] flex flex-wrap justify-between md:gap-[60px] gap-[30px]">
                <div className="flex gap-[12px] md:w-[calc(33.33%_-_40px)] w-[100%]">
                    ...
                    <div className="flex flex-1 items-center justify-between">
                        <div>
                            <h5 className="font-[500] leading-[24px] mb-[5px] text-[#1D2D5C] text-[16px] dark:text-white text-left">Search for the extension</h5>
                            <p className="text-[#535D7A] text-left text-[14px] font-[400] leading-[20px]">Look up the extension for further<br></br> information online.</p>
                        </div>
                    </div>
                </div>
                <div className="flex gap-[12px] md:w-[calc(33.33%_-_40px)] w-[100%]">
                    ...
                    <div className="flex flex-1 items-center justify-between">
                        <div>
                            <h5 className="font-[500] leading-[24px] mb-[5px] text-[#1D2D5C] text-[16px] dark:text-white text-left">Contact the seller</h5>
                            <p className="text-[#535D7A] text-left text-[14px] font-[400] leading-[20px]">Sure thing! Just reach out to <br></br> the seller.</p>
                        </div>
                    </div>
                </div>
                <div className="flex gap-[12px] md:w-[calc(33.33%_-_40px)] w-[100%]">
                    ...
                    <div className="flex flex-1 items-center justify-between">
                        <div>
                            <h5 className="font-[500] leading-[24px] mb-[5px] text-[#1D2D5C] text-[16px] dark:text-white text-left">Go into escrow and purchase</h5>
                            <p className="text-[#535D7A] text-left text-[14px] font-[400] leading-[20px]">Initiate escrow, proceed with <br></br> purchase for secure transaction.</p>
                        </div>
                    </div>
                </div>
            </div>
