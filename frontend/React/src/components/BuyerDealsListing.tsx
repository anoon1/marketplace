...
const DealsListing = () => {
    ...
    const [paymentStatus, getstatus] = useState([])
    ...
    return (
        <div className="bg-white">
            <div className="pt-[25px] px-[30px]">
                <form className="">
                    <div className="relative mb-[55px] max-w-[565px]">
            ...
            <div className="bg-white border-b border-[#E0E0E0]">
                ...
                <div className="grid grid-cols-7 pt-[24px] pb-[18px] px-[56px] sm:grid-cols-8">
                    ...
                    <div className="col-span-1 hidden items-center sm:flex leading-[18px]">
