...
const SellerListings = () => {
        ...
        const fetchData = async () => {
            try {
                ...
                if (responseData.data.data.length == 0) {
                    setSuccessMessage('No Listing Found');
                }
    ...
    return (
        <div className="bg-white overflow-auto">
            ...
            <div className="bg-white md:min-w-auto min-w-[1000px]">


                <div className="grid grid-cols-8 md:pt-[24px] pt-[20px] md:pb-[18px] pb-[14px] md:px-[56px] px-[15px] sm:grid-cols-8">
                ...
                <div className='bg-white h-[100%] p-40'  >
                    {success && (
                        <span className="bg-[green] text-center mt-[9px] max-w-[708px] w-full rounded-lg text-black py-[15px]">
                            <p>{success}</p>
                        </span>
                    )}
                </div>
