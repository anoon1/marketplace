...
const WelcomeBrand = () => {
    ...
    return (
        <div className="rounded-sm py-[94px] text-center bg-white center">
            ...
            {/* <div className="px-[110px] pt-[65px] pb-[48px] flex justify-between gap-[60px]">
                <div className="flex gap-[12px] w-[33.33%]">
                    ...
                    <div className="flex flex-1 items-center justify-between">
                        <div>
                            ...
                            <p className="text-[#535D7A] text-left text-[14px] font-[400] leading-[20px]">Enter your details to create the listing.</p>
                        </div>
                    </div>
                </div>
                <div className="flex gap-[12px] w-[33.33%]">
                    ...
                    <div className="flex flex-1 items-center justify-between">
                        <div>
                            ...
                            <p className="text-[#535D7A] text-left text-[14px] font-[400] leading-[20px]">Await admin's approval for your request or submission.</p>
                        </div>
                    </div>
                </div>
                <div className="flex gap-[12px] w-[33.33%]">
                    ...
                    <div className="flex flex-1 items-center justify-between">
                        <div>
                            ...
                            <p className="text-[#535D7A] text-left text-[14px] font-[400] leading-[20px]">Congratulations! Your listing is now available online.</p>
                        </div>
                    </div>
                </div>
            </div> */}
