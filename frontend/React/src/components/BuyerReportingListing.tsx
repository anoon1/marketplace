...
const BuyerReportingListing = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(`${appUrl}getBuyerReportListing`, {
                    method: 'POST',
                    headers: {
                ...
                if (data.reports.data.length == 0) {
                    navigate('/OnboardingBuyer/NoReportedListing');
                }
                setData(data.reports.data);
    ...
    return (
        <div className="bg-white overflow-auto">
            <div className="bg-white border-b border-[#E0E0E0] pt-[30px] md:min-w-auto min-w-[800px]">
                ...
                {data.map((item) => (
                    <div className="grid grid-cols-7 border-t border-[#E0E0E0] pt-[30px] pb-[30px] px-[48px]">
...
export default BuyerReportingListing;
